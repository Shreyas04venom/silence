...
import { Hand, Loader2, User } from "lucide-react"
...
export default function StudentSignupPage() {
  ...
  const handleGoogleSignup = async () => {
    console.log("Starting Google Signup for Student...")
    ...
    try {
      ...
      console.log("Storing student profile in Firestore...")
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign up to access your interactive lessons</CardDescription>
        </CardHeader>
        <CardContent>
